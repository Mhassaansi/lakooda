...
class Constants {
    companion object {
       ...
       val BASE_URL: String = "https://lakoda06.com/webservices/live/public/api/"
        ...
        const val PROMOTE_POST_URL = "post/promote"
        const val REPORT_POST_URL = "post/report"
        ...
        const val SHARESPROMOTE ="share_promote"
        ...
        // loaders
        var PROMOTE_RESPONSE = MutableLiveData(false)
        var PROMOTE_FEEDS_RESPONSE = MutableLiveData(false)
        var REPORT_RESPONSE = MutableLiveData(false)
        var REPORT_FEEDS_RESPONSE = MutableLiveData(false)
