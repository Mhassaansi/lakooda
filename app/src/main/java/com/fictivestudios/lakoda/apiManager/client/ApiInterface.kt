...
import com.fictivestudios.ravebae.utils.Constants.Companion.PROMOTE_POST_URL
import com.fictivestudios.ravebae.utils.Constants.Companion.REMOVE_FOLLOW_URL
import com.fictivestudios.ravebae.utils.Constants.Companion.REPORT_POST_URL
...
interface ApiInterface {
    ...
    @Multipart
    @POST(PROMOTE_POST_URL)
    fun promotePost(@PartMap hashMap: HashMap<String, Int>): retrofit2.Call<CommentResponse>

    @Multipart
    @POST(REPORT_POST_URL)
    fun reportPost(@PartMap hashMap: HashMap<String, Int>): retrofit2.Call<CommentResponse>
